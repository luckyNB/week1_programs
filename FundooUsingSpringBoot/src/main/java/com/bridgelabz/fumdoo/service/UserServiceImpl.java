...
import com.bridgelabz.fumdoo.Repository.UserRepository;
...
import com.bridgelabz.fumdoo.utility.ResponseHelper;
import com.bridgelabz.fumdoo.utility.TokenUtil;
import com.bridgelabz.fumdoo.utility.Utility;
...
public class UserServiceImpl implements UserService {
	...
	public ResponseToken onLogin(LoginDTO loginDto) {
		...
		if (userRepo.findByEmailId(loginDto.getEmailId()).isPresent()) {
			// System.out.println("trueeeee");
			Optional<User> user = userRepo.findByEmailId(loginDto.getEmailId());
			// System.out.println("email..."+userRepo.findByEmailId(loginDto.getEmailId()));
